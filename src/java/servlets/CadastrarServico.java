...
public class CadastrarServico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CadastrarServico</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CadastrarServico at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //passando valores
        servico.setServico(request.getParameter("servico"));
        servico.setCep(request.getParameter("cep"));
        servico.setNome(request.getParameter("nome"));
        servico.setEmail(request.getParameter("email"));
        servico.setTelefone(request.getParameter("telefone"));
        servico.setRua(request.getParameter("rua"));
        ...
        response.sendRedirect("cadastroservicos.jsp"); 
